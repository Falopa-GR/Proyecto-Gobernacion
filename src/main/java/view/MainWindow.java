...
public class MainWindow extends JFrame {
    ...
    private JPanel crearPanelModulos() {
        ...
        botones[0].addActionListener(e ->
                new PublicServerWindow().setVisible(true));

        // RF-02: Situaciones Administrativas  ← CONECTADO
        botones[1].addActionListener(e ->
                new AdministrativeSituationWindow().setVisible(true));

        // Después de la línea de RF-02 que ya agregaste:
        botones[2].addActionListener(e -> new VacationWindow().setVisible(true));
        // RF-03 al RF-07: aún en desarrollo
        for (int i = 2; i < botones.length; i++) {
            final int index = i;
